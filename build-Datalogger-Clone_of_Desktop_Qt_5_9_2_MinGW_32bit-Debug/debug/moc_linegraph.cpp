...
#include "../../Datalogger/linegraph.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LineGraph_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LineGraph_t qt_meta_stringdata_LineGraph = {
    {
QT_MOC_LITERAL(0, 0, 9), // "LineGraph"
...
void LineGraph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LineGraph *_t = static_cast<LineGraph *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject LineGraph::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LineGraph.data,
      qt_meta_data_LineGraph,  qt_static_metacall, nullptr, nullptr}
};
...
void *LineGraph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LineGraph.stringdata0))
