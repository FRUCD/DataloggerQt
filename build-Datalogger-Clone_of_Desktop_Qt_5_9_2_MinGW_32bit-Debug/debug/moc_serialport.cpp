...
#include "../../Datalogger/serialport.h"
...
QT_MOC_LITERAL(1, 11, 14), // "receivedPacket"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "CANMessage*"
QT_MOC_LITERAL(4, 39, 6), // "packet"
QT_MOC_LITERAL(5, 46, 16) // "readDataFromPort"

    },
    "SerialPort\0receivedPacket\0\0CANMessage*\0"
    "packet\0readDataFromPort"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receivedPacket((*reinterpret_cast< CANMessage*(*)>(_a[1]))); break;
        case 1: _t->readDataFromPort(); break;
        default: ;
        }
        ...
        {
            typedef void (SerialPort::*_t)(CANMessage * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::receivedPacket)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::receivedPacket(CANMessage * _t1)
{
